...
xlabels = ['Input f1', 'SOM f1', 'Input f2', 'SOM f2', 'Input f3', 'SOM f3']
plt.boxplot(e)
plt.xticks(range(1,7), xlabels)
plt.title("Color - DSOM1")
plt.tight_layout()
plt.show()
...
# plt.title("Weight3")
#
# plt.suptitle("Histogram for Hepta: First row for one of the DSOMs, second row for Centralised")
# plt.tight_layout()
# plt.show()
