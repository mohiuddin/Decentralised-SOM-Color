...
class MiniSom(object):
    def __init__(self, x, y, input_len, sigma=1.0, learning_rate=0.5,
        ...
        input_len : int
            Number of the elements of the vectors in myinput.
        ...
        decay_function : function (default=None)
            ...
            A custom decay function will need to to take in myinput
    ...
    def _check_input_len(self, data):
        """Checks that the data in myinput is of the correct shape."""
        data_len = len(data[0])
    ...
    def quantization_error(self, data):
        ...
        distance between each myinput sample and its best matching unit."""
        self._check_input_len(data)
    ...
    def topographic_error(self, data):
        ...
        for each myinput and then evaluating the positions.
